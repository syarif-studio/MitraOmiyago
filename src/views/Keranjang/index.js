      ...
      {props.cart && Array.isArray(props.cart.data) ? (
        <>
          <Content style={{ padding: 20 }}>
            {props.cart.data &&
              props.cart.data.map((cartItem, index) => (
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <View
                      ...
                      <View style={{ flexDirection: 'row' }}>
                        <Text>
                          Rp{' '}
                          {cartItem?.product?.price?.replace(
                            /\B(?=(\d{3})+(?!\d))/g,
                            '.'
                          )}
                        </Text>
                      ...
                      <View style={{ flexDirection: 'row' }}>
                        <Text>
                          Rp{' '}
                          {(cartItem?.product?.price * cartItem?.item?.qty)
                            .toString()
                            .replace(/\B(?=(\d{3})+(?!\d))/g, '.')}
                        </Text>
                      </View>
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          handleDeleteCartItem(cartItem?.item?.id)
                        }>
                        <Icon
                          name="trash"
                      ...
                      <TouchableOpacity
                        style={styles.iconBorder}
                        onPress={() => handleAddQty(cartItem?.product?.id)}>
                        <Icon name="add" />
                      </TouchableOpacity>
                    </View>
                  </View>
          ...
          <Footer>
            <FooterTab>
              ...
              <Button
                style={{ backgroundColor: '#e83e3e', flex: 3 }}
