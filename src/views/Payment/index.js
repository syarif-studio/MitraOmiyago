...
const midtransPayment = [2, 6, 10, 22];
...
class Payment extends Component {
  ...
  handlePaymentProcess = async () => {
    const processPayment = await payment.processPayment(
    ...
    if (midtransPayment.includes(this.state.payment.id)) {
      ...
      this.props.navigation.navigate('Midtrans', {
        payment: [this.state.payment.slug.replace('-', '_')],
      });
    } else {
    ...
    return (
      <Container>
            ...
            <View style={styles.ModalInnerContainer}>
              ...
              <Card>
                <CardItem>
                  {payment && (
                    <Body>
                      <Title style={{ color: '#333333', marginBottom: 10 }}>
                      ...
                      <Text style={{ marginBottom: 10 }}>
                        * Kode unik digunakan oleh omiyago untuk mempermudah
        ...
        <Header
          ...
          <Body>
            <Title style={{ marginLeft: -35, color: '#212529' }}>
              ...
              payments.data
                ...
                .map(({ payment, index }) => (
                  <ListItem key={payment.id} avatar>
                    ...
                    <Button
                      transparent
                      onPress={() => this.handleSelectPayment(payment)}>
