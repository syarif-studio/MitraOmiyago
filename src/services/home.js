...
export default {
  ...
  getOmiyagoProduct  : async() => api.post('product_category',{
      userName: 'beta',
      keyCode: 'beta12345',
      idCategory: 56
  }),
  ...
  getAllProduct  : async() => api.get('all_product/demo/fe01ce2a7fbac8fafaed7c982a04e229T2ZmaWNlT21peWFnbw==dfiu6aewruif3Kdl4395lkjLKdfg043Ar33gs0i22MyDad'),
